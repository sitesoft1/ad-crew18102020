...
class Style extends Supervisor
{
    ...
    {
		ob_start();var_dump($pStyles);error_log("Cell::applyFromArray: this->isSupervisor='".$this->isSupervisor."' pAdvanced='$pAdvanced' pStyles='".ob_get_contents()."'\n",3,'/home/juergen/htdocs/opencart-3-0-3-6/system/storage/logs/error.log');ob_end_clean();
