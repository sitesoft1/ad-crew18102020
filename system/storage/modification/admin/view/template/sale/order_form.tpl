...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $cancel; ?>" class="btn btn-default"><i class="fa fa-reply"></i> <?php echo $button_cancel; ?></a> <a href="<?php echo $omanager; ?>" class="btn btn-warning"><i class="fa fa-reply"></i> <?php echo $button_omanager; ?></a></div>
