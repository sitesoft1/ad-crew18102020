...
class ModelCheckoutOrder extends Model {
	...
	public function editOrder($order_id, $data) {
		...
		// Omanager ->
		if ($this->checkMapTables()) {
			$this->db->query("UPDATE `" . DB_PREFIX . "order` SET shipping_latitude = '0.000000', shipping_longitude = '0.000000' WHERE order_id = '" . (int)$order_id . "'");
		}
		// -> Omanager
	...
	// Omanager ->
	public function checkMapTables() {
